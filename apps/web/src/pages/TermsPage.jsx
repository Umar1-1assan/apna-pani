      ...
      <main className="flex-grow max-w-[800px] mx-auto px-5 py-12 md:py-20">
        ...
        <div className="space-y-8 text-[#414755] text-sm sm:text-base leading-relaxed">
          <section>
            ...
            <p>
              By accessing and using the Apna Pani platform, you agree to comply with and be bound by these Terms and Conditions. If you do not agree, please do not use the application.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Apna Pani is a multi-tenant platform facilitating water delivery management. Users must register an account with valid information (such as active phone numbers) to sign in. Each tenant is responsible for managing their internal user permissions and client details.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Water suppliers set pricing, log deliveries, and generate monthly customer invoices. Apna Pani provides automation tools but is not a party to financial transactions between suppliers, riders, and customers.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All software codebase, design systems, illustrations, trademarks, and interfaces of the Apna Pani platform are protected by intellectual property rights owned by Apna Pani Systems.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Apna Pani is provided "as is" without warranties of any kind. We are not liable for operational errors, delivery delays, routing miscalculations, or SMS/WhatsApp gateway communication issues.
            </p>
          </section>
        </div>
      </main>
